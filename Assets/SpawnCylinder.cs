...
{
    [SerializeField] private GameObject cylinder; // drag the dominant hand into this blank in the inspector
...
/*    private void Start()
    ...
    public void SpawnTheCylinder()
    {
        Vector3 cylinderSpawnPos = new Vector3(pov.transform.position.x, pov.transform.position.y+0.7f, pov.transform.position.z + 0.07f);
        Instantiate(cylinder, cylinderSpawnPos, Quaternion.identity);
    }
}
